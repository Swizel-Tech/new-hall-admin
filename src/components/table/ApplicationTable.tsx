        ...
        <AnimatePresence>
          ...
          >
            ...
            >
              ...
              <h2 className="font-OpenSans bg-white text-[#1EB3FE] text-center text-[26px] font-normal leading-[44px]">
                Name Application for Teaching Position
              </h2>
              <ApplicationForm application_id={isApplication_id} />
            </div>
          </motion.div>
        </AnimatePresence>
      )}
